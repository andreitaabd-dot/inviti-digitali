...
function applyConfig() {
  ...
  setLink(
    "btnCalendar",
    `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent("Festa di Aureliano")}&dates=20260614T100000/20260614T130000&details=${encodeURIComponent("Save the date - Festa di Aureliano")}&location=${encodeURIComponent(INVITO_CONFIG.indirizzoMaps || "")}`
  );
